...
namespace Phoenix.Helpers
{
    public class CensorHelper
    {
        ...
        public CensorHelper(IEnumerable<string> censoredWords)
        {
        ...
        {
            string bannedWordReplaceCharactor = "";//TODO
            var word = m.Captures[0].Value;
            return new string(Convert.ToChar(bannedWordReplaceCharactor), word.Length);
        }
