...
namespace Phoenix.Areas.Admin.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        //        catch (Exception)
        //        {
        //            culture = Phoenix.Core.WebUtils.GetDefaultCulture();
        //        }
        ...
        //        sbSiteVars.Append("ApplicationRelativeWebRoot: '" + Phoenix.Core.WebUtils.ApplicationRelativeWebRoot + "',");
        //        sbSiteVars.Append("RelativeWebRoot: '" + Phoenix.Core.WebUtils.RelativeWebRoot + "',");
        //        sbSiteVars.Append("AbsoluteWebRoot:  '" + Phoenix.Core.WebUtils.AbsoluteWebRoot + "',");
        ...
        //        sbSiteVars.Append("BlogFilesFolder: '" + Phoenix.Core.WebUtils.FilesFolder + "',");
        ...
        //        sbSiteVars.Append("Version: 'Phoenix.NET " + BlogSettings.Instance.Version() + "'");
