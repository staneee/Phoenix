 ...
 * textarea 插入内容
 */
exports.insertTextAtCaret = function (obj, _a, $vm) {
    var prefix = _a.prefix, subfix = _a.subfix, str = _a.str;
    obj.focus();
 ...
 * 生成导航目录
 */
exports.getNavigation = function ($vm, full) {
 ...
 * 滚动条联动
 */
exports.scrollLink = function ($event, $vm) {
 ...
 * @param $vm
 */
exports.fullscreenchange = function ($vm) {
    // 阅读模式 全屏监听事件
 ...
 * @param $vm
 */
exports.windowResize = function ($vm) {
...
exports.ImagePreviewListener = function ($vm) {
